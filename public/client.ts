...
const choiceDiv = document.getElementById('choiceDiv') as HTMLDivElement
if (choiceDiv == null) {
  throw new Error('choiceDiv not found')
}
const leftOptionDiv = document.getElementById('leftOptionDiv') as HTMLDivElement
if (leftOptionDiv == null) {
  throw new Error('leftOptionDiv not found')
}
const rightOptionDiv = document.getElementById('rightOptionDiv') as HTMLDivElement
if (rightOptionDiv == null) {
  throw new Error('rightOptionDiv not found')
}
const rankTable = document.getElementById('rankTable') as HTMLTableElement
if (rankTable == null) {
