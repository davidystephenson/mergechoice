...
describe('operation4', () => {
  verifyFlowStep({
    ...
    ranking: [
      ...
      { uid: 'awakens', points: 4, rank: 3 },
      { uid: 'reloaded', points: 4, rank: 3 },
      { uid: 'path', points: 3, rank: 4 },
      { uid: 'online', points: 2, rank: 5 },
      { uid: 'original', points: 2, rank: 5 },
      { uid: 'enter', points: 1, rank: 6 },
...
describe('operation6', () => {
  verifyFlowStep({
    ...
    ranking: [
      ...
      { uid: 'awakens', points: 4, rank: 4 },
      { uid: 'original', points: 3, rank: 5 },
      { uid: 'path', points: 3, rank: 5 },
      { uid: 'online', points: 2, rank: 6 },
      { uid: 'enter', points: 1, rank: 7 },
...
describe('operation8', () => {
  verifyFlowStep({
    ...
    ranking: [
      { uid: 'resurrections', points: 8, rank: 1 },
      { uid: 'revolutions', points: 7, rank: 2 },
      { uid: 'reloaded', points: 6, rank: 3 },
      { uid: 'awakens', points: 4, rank: 4 },
      { uid: 'original', points: 4, rank: 4 },
      { uid: 'path', points: 3, rank: 5 },
      { uid: 'online', points: 2, rank: 6 },
...
describe('operation9', () => {
  verifyFlowStep({
    ...
    ranking: [
      ...
      { uid: 'revolutions', points: 7, rank: 2 },
      { uid: 'reloaded', points: 6, rank: 3 },
      { uid: 'original', points: 5, rank: 4 },
      { uid: 'awakens', points: 4, rank: 5 },
      { uid: 'path', points: 3, rank: 6 },
      { uid: 'online', points: 2, rank: 7 },
      { uid: 'enter', points: 1, rank: 8 },
